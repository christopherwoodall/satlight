// Stereographic projection: azimuthal dome with less horizon compression.
// r = R * tan((90 - alt) / 2). Below-horizon satellites clamp to the ring.
...
// Normalize so the horizon (alt 0 -> tan(45deg) = 1) sits exactly at R.
function radiusForAlt(alt, R) {
  return R * Math.tan(((90 - alt) / 2) * (Math.PI / 180));
}
...
projections.register("stereographic", {
  id: "stereographic",
  label: "STEREO",
  project,
  drawGuides,
